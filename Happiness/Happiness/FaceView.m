...
- (void)drawRect:(CGRect)rect
{
    ...
    // draw moouth
    CGPoint mouthStart;
    mouthStart.x = midPoint.x  - MOUSE_H * size;
    mouthStart.y = midPoint.y + MOUSE_V * size;
    
    CGPoint mouthEnd = mouthStart;
    mouthEnd.x += MOUSE_H * size * 2;
    
    CGPoint mouthCP1 = mouthStart;
    mouthCP1.x += MOUSE_H * size * 2 / 3;
    
    CGPoint mouthCP2 = mouthEnd;
    mouthCP2.x -= MOUSE_H * size * 2 / 3;
